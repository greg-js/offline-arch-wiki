...
exports.article = function scrapeArticle(articleObj, isCategory) {
  ...
  return request(url).then(function successScrape(htmlString) {
    ...
    function isTextDescription(text) {
      var badFirstWordsRE = /Contents|From|Related|Warning/i;
      var badContentRE = /article or section needs|article is a stub|article or section is out of date|is a candidate for merging|Package creation guidelines/i;
