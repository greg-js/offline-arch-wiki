...
* [3.3 CMAKE (KDE) applications](#CMAKE_.28KDE.29_applications)
...
**Reason:** Recommending ignore-deps is dubious (Discuss in [Talk:Debug - Getting Traces#](https://wiki.archlinux.org/index.php/Talk:Debug_-_Getting_Traces))

**Note:**

Compiling Qt with [qtwebkit](https://www.archlinux.org/packages/?name=qtwebkit) installed may cause compilation errors. Hence, remove qtwebkit package temporarily from your system. Use the following command in order to ignore any dependencies on qtwebkit.
...
Retrieved from "[https://wiki.archlinux.org/index.php?title=Debug_-_Getting_Traces&oldid=405076](https://wiki.archlinux.org/index.php?title=Debug_-_Getting_Traces&oldid=405076)"
