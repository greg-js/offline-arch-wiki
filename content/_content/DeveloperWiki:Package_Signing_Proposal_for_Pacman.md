...
* Each Key Signer sends the other KSKs to the server again, to update the signatures.
...
* Pacman downloads the repo.db and its corresponding signature. The following should happen:
